        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentAuthorityId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Authorities_Authorities_ParentAuthorityId",
                        column: x => x.ParentAuthorityId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasFirstAidCertificate = table.Column<bool>(type: "bit", nullable: false),
                    FirstAidCertificateDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Certifications = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SpecialSkills = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdateDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeleteDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreateBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Members_Authorities_AuthorityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Teams_Location_LocationId",
                        column: x => x.LocationId,
                        principalTable: "Location",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Teams_Members_TeamLeaderId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Warehouses_Members_ResponsibleMemberId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Authorities_ParentAuthorityId",
                table: "Authorities",
                column: "ParentAuthorityId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Warehouses_ResponsibleMemberId",
                table: "Warehouses",
